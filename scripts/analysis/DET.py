...
colorStyle = [
    ('brown', '-', 2),  # black #both eyebrows
    ('black', '--', 2),  # blue #both eyes
    ('red', '-.', 2),  # red # chin
    ('green', ':', 2),  # green # face ISOV
    ('orange', '-', 2),  # magenta #forehead
    ('blue', '--', 2),  # orange # left ear

    ('skyblue', ':', 2),  # black # left eye
    ('turquoise', ':', 2),  # blue # left eyebrow
    ('olive', ':', 2),  # red # left middle face
    ('lightcoral', '-', 2),  # green #mouth
    ('darkgreen', '-.', 2),  # magenta # normalized
    ('gold', '-', 2),  # orange # nose

    ('orchid', '-.', 2),  # black #right ear
    ('lightpink', '-', 2),  # blue #right eye
    ('darkviolet', '--', 2),  # red # right eyebrow
    ('lightseagreen', '-.', 2),  # green #right middle face
...
class DET:
    ...
    def plot(self, tar, non, label='', style='color', plot_args='', dissimilarity_scores=False, plot_rocch=False):
