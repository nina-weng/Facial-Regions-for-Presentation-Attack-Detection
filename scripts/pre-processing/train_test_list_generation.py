...
if __name__ == '__main__':
    ...
    train_set_dirs = [os.path.join(normalized_dir,str(i)) for i in range(1,16)]
    test_set_dirs = [os.path.join(normalized_dir, str(i)) for i in range(16, 21)]

    txt_dir = '..\..\\train_test_info'
    train_txt_fname = 'train_15_10.txt'
    test_txt_fname='test_5_10.txt'
